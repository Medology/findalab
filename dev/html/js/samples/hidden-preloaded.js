...
var $ = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.noConflict(true);
/**
...
$.fn.extend({
   ...
   * @returns {Findalab}
   */
  findalab: function findalab(settings) {
    var self = this;
    /**
    ...
    this.construct = function (settings) {
      ...
      this.fadeIntoView(); // Capture lab selection events

      this.on('click', '[data-findalab-result-button]', onLabSelectClick.bind(this));
      this.on('mouseenter', '[data-findalab-result]', onLabHover.bind(this));
      this.on('mouseleave', '[data-findalab-result]', onLabUnhover.bind(this));
      /**
    ...
    this.centerMap = function (lat, _long) {
      ...
      var handleGeoCodeResponse = function handleGeoCodeResponse(results, status) {
    ...
    var _onFindLocationSubmit = function _onFindLocationSubmit(event) {
      ...
      if (!navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(_searchByCoords, _displayGeolocateError, {
          timeout: 20000
        });
      }
      /**
...
/***/ "./src/js/pages-test/hidden-preloaded.js":
/*!***********************************************!*\
  !*** ./src/js/pages-test/hidden-preloaded.js ***!
  \***********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _findalab__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../findalab */ "./src/js/findalab.js");


window.initMap = function () {
  Object(_findalab__WEBPACK_IMPORTED_MODULE_0__["default"])('#findalab').load('/template/findalab.html', function () {
    window.labfinder = Object(_findalab__WEBPACK_IMPORTED_MODULE_0__["default"])(this).find('.findalab').findalab({
      baseURL: 'http://findalab.local/fixtures/hidden-preloaded'
    });

    window.labfinder.onSearchSuccess = function () {
      Object(_findalab__WEBPACK_IMPORTED_MODULE_0__["default"])('#map-show').on('click', function () {
        Object(_findalab__WEBPACK_IMPORTED_MODULE_0__["default"])('#hidden').show();
        window.labfinder.resize();
        Object(_findalab__WEBPACK_IMPORTED_MODULE_0__["default"])(this).hide();
      });
      Object(_findalab__WEBPACK_IMPORTED_MODULE_0__["default"])('#map-ready').text('Map Ready');
    };
...
/***/ 7:
/*!*****************************************************!*\
  !*** multi ./src/js/pages-test/hidden-preloaded.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /workdir/src/js/pages-test/hidden-preloaded.js */"./src/js/pages-test/hidden-preloaded.js");
