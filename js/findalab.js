    ...
    findalab: function(settings) {
      ...
      this.construct = function(settings) {
        ...
        function onLabUnhover(event) {
          ...
          iconMarker = this._buildIconMarkerNetwork(angular.isString(this.myLab.network) ? this.myLab.network : this.myLab.network.name);
      ...
      this._buildInfoWindowMarkerContent = function(lab) {
          ...
          if (this.checkRecommended && this._isRecommended(angular.isString(lab.network) ? lab.network : lab.network.name)) {
          ...
          if (self.settings.lab.hasButton) {
              infoWindowContent +=
                  ...
                  'data-network="' + (angular.isString(lab.network) ? lab.network : lab.network.name) + '" ' +
