...
window.initMap = function () {
  initMap('#findalab').load('/template/findalab.html', function () {
    window.labfinder = findalab = initMap(this).find('.findalab').findalab({
  ...
  initMap('#findalab-keep-lab').on('click', function () {
    testDisableEnable();
  });
  initMap('body').on('click', '[data-findalab-ihc-button]', function () {
    testDisableEnable();
  });
  ...
  function testDisableEnable() {
    ...
    setTimeout(function () {
      initMap('#findalab-success-msg').html('<h3>Success!</h3>');
